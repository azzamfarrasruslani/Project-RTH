    ...
    <div className="w-full">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-10">
              <div className="inline-block bg-primary-light px-4 py-1.5 rounded-full mb-6">
                <span className="text-primary-dark font-semibold text-sm tracking-wide">
                  Kota Cerdas Hijau
                </span>
              </div>
              ...
              <p className="text-lg text-teks-samping mb-8 max-w-lg leading-relaxed">
                Akses mudah ke data ruang hijau untuk masyarakat dan pemerintah
                demi kota yang lebih hijau, nyaman, dan berkelanjutan.
              </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h5 className="font-bold text-lg mb-1">
                        Temukan dan Kunjungi
                      </h5>
                      <p className="text-xs text-gray-300 leading-relaxed">
                        Jelajahi berbagai taman kota dan hutan kota di
                        Pekanbaru.
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-4">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Akses informasi spasial yang akurat dan mutakhir untuk
                pengelolaan RTH yang lebih efektif dan berkelanjutan.
              </p>
            </div>
            ...
            <div className="lg:col-span-4 space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">
                    Perencanaan Tata Ruang Optimal
                  </h3>
                  <p className="text-gray-400 text-sm">
                    Mendukung keputusan berbasis data untuk pengembangan kota
                    yang teratur.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Menyajikan informasi RTH yang mudah diakses oleh masyarakat.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Menyediakan informasi yang relevan bagi pemerintah daerah.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Mendorong upaya pelestarian dan pemantauan kualitas
                    lingkungan.
                  </p>
                </div>
              </div>
      ...
      <section className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-primary-dark font-bold text-sm tracking-widest uppercase mb-4 block">
            // Fitur Utama
          </span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 text-left group">
              ...
              <p className="text-teks-samping text-sm leading-relaxed">
                Informasi lengkap seputar taman kota, lokasi, fasilitas, dan
            ...
            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 text-left group">
              ...
              <p className="text-teks-samping text-sm leading-relaxed">
                Menyajikan informasi biodiversitas dan kawasan konservasi hutan
                hijau di paru-paru kota.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 text-left group">
              ...
              <p className="text-teks-samping text-sm leading-relaxed">
                Jelajahi persebaran RTH secara visual. Dilengkapi dengan
                visualisasi data spasial yang akurat.
              </p>
            </div>
      ...
      <section className="bg-primary-dark py-24 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="space-y-12 relative">
                ...
                <div className="relative flex gap-8">
                  <div className="relative z-10">
                    <div className="w-8 h-8 bg-accent rounded-full flex items-center justify-center text-primary-dark font-bold text-sm">
                      01
                    </div>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-300 text-sm max-w-sm">
                      Temukan Taman dan Hutan Kota di Pekanbaru melalui peta
                      digital kami.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative flex gap-8">
                  <div className="relative z-10">
                    <div className="w-8 h-8 bg-primary-dark border-2 border-accent rounded-full flex items-center justify-center text-accent font-bold text-sm">
                      02
                    </div>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-300 text-sm max-w-sm">
                      Klik RTH untuk info detail luas, kategori, dan status
                      wilayah.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative flex gap-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm max-w-sm">
                      Gunakan data ini untuk keputusan, penelitian, atau edukasi
                      RTH.
                    </p>
                  </div>
                </div>
            ...
            <div className="relative h-full grid-cols-2">
              <div className="absolute top-0 right-0 w-full h-full rounded-3xl overflow-hidden border-4 border-white/10 shadow-2xl">
                <img
                  src="/images/hero.png"
                  alt="Park Map"
                  className="w-full h-full object-cover"
